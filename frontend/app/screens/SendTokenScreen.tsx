...
export default function SendTokenScreen() {
  ...
  const decimals = parseInt(params.decimals as string);
  const tokenBalance = params.balance as string;
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Send {symbol}</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.balanceCard}>
          ...
          <Text style={styles.balanceText}>
            {parseFloat(tokenBalance).toFixed(6)} {symbol}
          </Text>
        </View>
        ...
        >
          {loading ? (
            ...
            <Text style={styles.buttonText}>Send {symbol}</Text>
          )}
        </TouchableOpacity>
      </ScrollView>
    </KeyboardAvoidingView>
